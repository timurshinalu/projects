...
**Описание:** в данном проекте мной были изучены принципы событийной аналитики. Я построила
...
**Используемые библиотеки:**  `pandas`, `matplotlib`, `plotly`, `scipy`, `numpy`, `math`.
